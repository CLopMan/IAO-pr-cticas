...
\label{sec:parte1}
    ...
    \begin{table}[H]
        \begin{center}
            \begin{tabular}{ @{}clc@{} }
                ...
                \bottomrule
            \end{tabular}
            \caption{Parámetros y \textit{Accuracy} de los diferentes modelos - Parte 1}
        \end{center}
    \end{table}
    ...
    \begin{figure}[H]
        ...
        \caption{Resultado del \textit{t-test} de los modelos en el conjunto de \textit{train} - Parte 1}
    \end{figure}
...
\label{sec:parte2}
    ...
    \begin{table}[H]
        \begin{center}
            \begin{tabular}{ @{}clc@{} }
                ...
                \bottomrule
            \end{tabular}
            \caption{Parámetros y \textit{Accuracy} de los diferentes modelos - Parte 2}
        \end{center}
    \end{table}
    ...
    \begin{figure}[H]
        ...
        \caption{Resultado del \textit{t-test} de los modelos en el conjunto de \textit{train} - Parte 2}
    \end{figure}
