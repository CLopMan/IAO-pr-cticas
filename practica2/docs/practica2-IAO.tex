...
\label{sec:parte1}
    ...
    \begin{table}[H]
        \begin{center}
            \begin{tabular}{ @{}clc@{} }
                ...
                \midrule
                1  & (\textit{TF-IDF}, $3\%$                 \textit{Deep Learning})  & 0.842\\
                2  & (\textit{TF-IDF}, $3\%$                 \textit{Random Forest})  & 0.660\\
                3  & (\textit{TF-IDF}, $3\%$                 \textit{Naive Bayes})    & 0.778\\
                4  & (\textit{TF-IDF}, $3\%$                 \textit{Decision Trees}) & 0.665\\
                5  & (\textit{Binary Term Occurrence}, $3\%$ \textit{Deep Learning})  & 0.843\\
                6  & (\textit{Binary Term Occurrence}, $3\%$ \textit{Random Forest})  & 0.805\\
                7  & (\textit{Binary Term Occurrence}, $3\%$ \textit{Naive Bayes})    & 0.748\\
                8  & (\textit{Binary Term Occurrence}, $3\%$ \textit{Decision Trees}) & 0.798\\
                9  & (\textit{TF-IDF}, $10\%$,               \textit{Deep Learning})  & 0.819\\
                10 & (\textit{TF-IDF}, $10\%$,               \textit{Random Forest})  & 0.743\\
                11 & (\textit{TF-IDF}, $10\%$,               \textit{Naive Bayes})    & 0.748\\
                12 & (\textit{TF-IDF}, $10\%$,               \textit{Decision Trees}) & 0.749\\
                \bottomrule
            \end{tabular}
    ...
    \textit{accuracy}, manteniendo una gran simplicidad  al usar \textit{prune below $10\%$}.
...
\label{sec:parte2}
    ...
    Al observar la comparación por pares
    proporcionada por el \textit{t-test}, destaca de nuevo el modelo 9 (\textit{Deep Learning}
