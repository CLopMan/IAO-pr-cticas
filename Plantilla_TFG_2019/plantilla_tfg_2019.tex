...
\chapter{Proceso de entrenamiento}
	...
	\section{Parte 1}
        ...
        Para el entrenamiento de distintos modelos trabajaremos con variaciones sobre 3 parámetros de la red neuronal (número de capas ocultas, \textit{loss function} y \textit{learning rate}). Además, aplicaremos previamente un filtrado de datos eliminando un atributo que es constante para cada embalse. Esto resulta en 16 modelos distintos. También incluiremos un modelo extra con los valores por defecto como modelo de control.
        ...
        \begin{itemize}
            ...
            \item \textit{loss function}: \{\textit{quadratic}, \textit{Huber}\}.
