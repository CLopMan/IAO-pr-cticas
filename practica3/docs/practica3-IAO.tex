...
%        En este paso se ha comenzado con las variables de entrada propuestas,
%        tras lo cual se han añadido nuevas variables que se consideran
%        importantes en la búsqueda de vivienda del perfil seleccionado. En
%        todos los casos el rango de las variables ha sido definido mediante una
%        búsqueda de los valores mínimos y máximos posibles de estas entre las
%        viviendas en alquiler en la zona, aunque por la naturaleza de algunos
%        de los atributos se ha expandido la función de pertenencia hasta el
%        valor 0.
        ...
        asegurado en todos los casos con excepción de aquellos
        \textit{booleanos} que el mínimo número de etiquetas borrosas del
        atributo sea 3. 
