...
\pagenumbering{arabic} % numeración con múmeros arábigos para el resto de la publicación
    ...
    \label{chap:intro}
        ...
        Con todo lo anterior es evidente que un modelo con las características descritas presenta una gran utilidad para el colectivo de estudiantes. Además, el uso de logica borrosa presenta claras ventajas para el desarrollo de este sistema.

    \chapter{Desarrollo del sistema}
    \label{chap:desarrollo}
        En este capítulo se describe el proceso de creación del sistema, incluyendo la elección de atributos de entrada, sus rangos y funciones de pertenencia, las etiquetas de la 
        variable de salida, así como la definición de reglas difusas. 
        
        Todos los pasos de este proceso han venido guiados por el perfil elegido del estudiante, que tiene un bajo poder adquisitivo y busca un piso relativamente pequeño, cerca de 
        paradas de transporte público y preferiblemente amueblado. Con estas características se han elegido un total de 7 atributos de entrada así como 16 reglas, que se considera
        que pueden representar de manera precisa las preferencias de este estudiante.
        Aún con el perfil ya definido como el principal, se considera un caso secundario en el que el usuario busca un piso de varias habitaciones que pueda compartir, 
        lo cual resulta en algunas reglas adicionales en el proceso. 

        Para el desarrollo se va a utilizar el operador \textit{Fuzzy Logic Toolbox} de MATLAB para crear un sistema de Mamdani Type1 FIS. Esta herramienta permite la selección
    ...
    \section{Variables de entrada}
        En este paso se ha comenzado con las variables de entrada propuestas, tras lo cual se han añadido nuevas variables que se consideran importantes en la búsqueda de vivienda
        del perfil seleccionado. En todos los casos el rango de las variables ha sido definido mediante una búsqueda de los valores mínimos y máximos posibles de estas entre 
        las viviendas en alquiler en la zona, aunque por la naturaleza de algunos de los atributos se ha expandido la función de pertenencia hasta el valor 0. 

        Los conjuntos borrosos y sus funciones de pertenencia de cada atributo han sido definidos según las características de cada uno, teniendo el cuenta el rango así como los valores
        medios de cada variable. Aún así, se ha asegurado en todos los casos con excepción de aquellos \textit{booleanos} que el mínimo número de etiquetas borrosas del atributo sea 3. 
    ...
    En este apartado se describen las reglas establecidas para el sistema.
