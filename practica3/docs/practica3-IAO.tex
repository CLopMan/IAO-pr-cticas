...
\pagenumbering{arabic} % numeración con múmeros arábigos para el resto de la publicación
    ...
    \label{chap:intro}
        ...
        objetivo este proyecto se pretende crear un sistema de recomendación de
        pisos para estudiantes basado en lógica borrosa.
        ...
        \begin{itemize}
            \item \textbf{Gestión de incertidumbre y ambigüedad}: a través de las funciones de pertenencia para cada etiqueta los sistemas basados en reglas borrosas son capaces de manejar datos ambigüos o incompletos. Esta es una característica fundamental para los sistemas de recomendación.
