...
def rm_main(input0):
    ...
    embalses_filtrados = ["Sequeiros", "Montefurado", "San Martiño", "Guístolas", "Santa Eulalia", "Prada", "Bao", "Cenza", "Chandrexa", "Edrada-Mao"]  # Modificar esta lista según se necesite
