...
Nos se han podido extraer más medidas por errores con el software de Altair. Destaca la correlación de 0, no obstante, debido al buen resultado de las predicciones (incluso cambiando la semilla) consideramos este resultado a un error más del software.
...
Tal y como se especuló al principio del proyecto, el tatamiento de los datos como una serie temporal supone un mejor rendimiento debido a la asuencia de \textit{data leaks} y la naturaleza de los datos.

\chapter{Conclusión}
\label{chap:conclusion}

Esta práctica nos ha introducido al uso de herramientas especializadas en el trabajo con modelos de inteligencia artificial. Hemos encontrado el uso de estas herramientas útil debido al alto grado de absatracción que presenta, permitiendo que usuarios no experimentados en el mundo de la programación puedan aprovechar las ventajas de los algoritmos de \textit{Machine Learning}. No obstante, los errores observados durante el desarrollo nos hace pensar que su aplicación debería ser en proyectos de poca criticidad o con fines puramente didácticos.
